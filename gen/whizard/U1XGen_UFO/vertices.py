...
V_22 = Vertex(name = 'V_22',
              particles = [ P.G0, P.G0, P.G0, P.phiZp ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
              couplings = {(0,0):C.GC_25})

V_23 = Vertex(name = 'V_23',
              particles = [ P.G0, P.H1, P.H1, P.phiZp ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
              couplings = {(0,0):C.GC_17})

V_24 = Vertex(name = 'V_24',
              particles = [ P.G0, P.H1, P.H2, P.phiZp ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
              couplings = {(0,0):C.GC_15})

V_25 = Vertex(name = 'V_25',
              particles = [ P.G0, P.H2, P.H2, P.phiZp ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
              couplings = {(0,0):C.GC_16})

V_26 = Vertex(name = 'V_26',
              particles = [ P.G0, P.G0, P.phiZp, P.phiZp ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
              couplings = {(0,0):C.GC_28})

V_27 = Vertex(name = 'V_27',
              particles = [ P.H1, P.H1, P.phiZp, P.phiZp ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
              couplings = {(0,0):C.GC_22})

V_28 = Vertex(name = 'V_28',
              particles = [ P.H1, P.H2, P.phiZp, P.phiZp ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
              couplings = {(0,0):C.GC_19})

V_29 = Vertex(name = 'V_29',
              particles = [ P.H2, P.H2, P.phiZp, P.phiZp ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
              couplings = {(0,0):C.GC_20})

V_30 = Vertex(name = 'V_30',
              particles = [ P.G0, P.phiZp, P.phiZp, P.phiZp ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
              couplings = {(0,0):C.GC_24})

V_31 = Vertex(name = 'V_31',
              particles = [ P.phiZp, P.phiZp, P.phiZp, P.phiZp ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
...
V_38 = Vertex(name = 'V_38',
              particles = [ P.G0, P.H1, P.phiZp ],
              color = [ '1' ],
              lorentz = [ L.SSS1 ],
              couplings = {(0,0):C.GC_154})

V_39 = Vertex(name = 'V_39',
              particles = [ P.G0, P.H2, P.phiZp ],
              color = [ '1' ],
              lorentz = [ L.SSS1 ],
              couplings = {(0,0):C.GC_153})

V_40 = Vertex(name = 'V_40',
              particles = [ P.H1, P.phiZp, P.phiZp ],
              color = [ '1' ],
              lorentz = [ L.SSS1 ],
              couplings = {(0,0):C.GC_158})

V_41 = Vertex(name = 'V_41',
              particles = [ P.H2, P.phiZp, P.phiZp ],
              color = [ '1' ],
              lorentz = [ L.SSS1 ],
...
V_46 = Vertex(name = 'V_46',
              particles = [ P.W__minus__, P.W__plus__, P.G0, P.phiZp ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
              couplings = {(0,0):C.GC_36})

V_47 = Vertex(name = 'V_47',
              particles = [ P.W__minus__, P.W__plus__, P.phiZp, P.phiZp ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
...
V_52 = Vertex(name = 'V_52',
              particles = [ P.Z, P.H1, P.phiZp ],
              color = [ '1' ],
              lorentz = [ L.VSS1 ],
              couplings = {(0,0):C.GC_63})

V_53 = Vertex(name = 'V_53',
              particles = [ P.Z, P.H2, P.phiZp ],
              color = [ '1' ],
              lorentz = [ L.VSS1 ],
...
V_58 = Vertex(name = 'V_58',
              particles = [ P.Z, P.Z, P.G0, P.phiZp ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
              couplings = {(0,0):C.GC_80})

V_59 = Vertex(name = 'V_59',
              particles = [ P.Z, P.Z, P.phiZp, P.phiZp ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
...
V_62 = Vertex(name = 'V_62',
              particles = [ P.Zp, P.G0, P.H1 ],
              color = [ '1' ],
              lorentz = [ L.VSS1 ],
              couplings = {(0,0):C.GC_72})

V_63 = Vertex(name = 'V_63',
              particles = [ P.Zp, P.G0, P.H2 ],
              color = [ '1' ],
              lorentz = [ L.VSS1 ],
              couplings = {(0,0):C.GC_73})

V_64 = Vertex(name = 'V_64',
              particles = [ P.Zp, P.H1, P.phiZp ],
              color = [ '1' ],
              lorentz = [ L.VSS1 ],
              couplings = {(0,0):C.GC_74})

V_65 = Vertex(name = 'V_65',
              particles = [ P.Zp, P.H2, P.phiZp ],
              color = [ '1' ],
              lorentz = [ L.VSS1 ],
...
V_69 = Vertex(name = 'V_69',
              particles = [ P.Z, P.Zp, P.phiZp, P.phiZp ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
...
V_71 = Vertex(name = 'V_71',
              particles = [ P.Z, P.Zp, P.G0, P.phiZp ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
...
V_77 = Vertex(name = 'V_77',
              particles = [ P.Zp, P.Zp, P.phiZp, P.phiZp ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
...
V_79 = Vertex(name = 'V_79',
              particles = [ P.Zp, P.Zp, P.G0, P.phiZp ],
              color = [ '1' ],
              lorentz = [ L.VVSS1 ],
...
V_127 = Vertex(name = 'V_127',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV3, L.FFV4 ],
               couplings = {(0,0):C.GC_54,(0,1):C.GC_56})
...
V_154 = Vertex(name = 'V_154',
               particles = [ P.d__tilde__, P.d, P.phiZp ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS3 ],
               couplings = {(0,0):C.GC_174})

V_155 = Vertex(name = 'V_155',
               particles = [ P.s__tilde__, P.s, P.phiZp ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS3 ],
               couplings = {(0,0):C.GC_186})

V_156 = Vertex(name = 'V_156',
               particles = [ P.b__tilde__, P.b, P.phiZp ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS3 ],
...
V_166 = Vertex(name = 'V_166',
               particles = [ P.e__plus__, P.e__minus__, P.phiZp ],
               color = [ '1' ],
               lorentz = [ L.FFS3 ],
               couplings = {(0,0):C.GC_178})

V_167 = Vertex(name = 'V_167',
               particles = [ P.mu__plus__, P.mu__minus__, P.phiZp ],
               color = [ '1' ],
               lorentz = [ L.FFS3 ],
               couplings = {(0,0):C.GC_182})

V_168 = Vertex(name = 'V_168',
               particles = [ P.ta__plus__, P.ta__minus__, P.phiZp ],
               color = [ '1' ],
               lorentz = [ L.FFS3 ],
...
V_178 = Vertex(name = 'V_178',
               particles = [ P.u__tilde__, P.u, P.phiZp ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS3 ],
               couplings = {(0,0):C.GC_198})

V_179 = Vertex(name = 'V_179',
               particles = [ P.c__tilde__, P.c, P.phiZp ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS3 ],
               couplings = {(0,0):C.GC_170})

V_180 = Vertex(name = 'V_180',
               particles = [ P.t__tilde__, P.t, P.phiZp ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS3 ],
...
V_188 = Vertex(name = 'V_188',
               particles = [ P.ve__tilde__, P.n1, P.H1 ],
               color = [ '1' ],
               lorentz = [ L.FFS2 ],
               couplings = {(0,0):C.GC_97})

V_189 = Vertex(name = 'V_189',
               particles = [ P.ve__tilde__, P.n1, P.H2 ],
               color = [ '1' ],
               lorentz = [ L.FFS2 ],
               couplings = {(0,0):C.GC_98})

V_190 = Vertex(name = 'V_190',
               particles = [ P.n1, P.ve, P.H1 ],
               color = [ '1' ],
               lorentz = [ L.FFS4 ],
               couplings = {(0,0):C.GC_97})

V_191 = Vertex(name = 'V_191',
               particles = [ P.n1, P.ve, P.H2 ],
               color = [ '1' ],
               lorentz = [ L.FFS4 ],
               couplings = {(0,0):C.GC_98})

V_192 = Vertex(name = 'V_192',
               particles = [ P.vm__tilde__, P.n1, P.H1 ],
               color = [ '1' ],
               lorentz = [ L.FFS2 ],
               couplings = {(0,0):C.GC_102})

V_193 = Vertex(name = 'V_193',
               particles = [ P.vm__tilde__, P.n1, P.H2 ],
               color = [ '1' ],
               lorentz = [ L.FFS2 ],
               couplings = {(0,0):C.GC_103})

V_194 = Vertex(name = 'V_194',
               particles = [ P.n1, P.vm, P.H1 ],
               color = [ '1' ],
               lorentz = [ L.FFS4 ],
               couplings = {(0,0):C.GC_102})

V_195 = Vertex(name = 'V_195',
               particles = [ P.n1, P.vm, P.H2 ],
               color = [ '1' ],
               lorentz = [ L.FFS4 ],
               couplings = {(0,0):C.GC_103})

V_196 = Vertex(name = 'V_196',
               particles = [ P.vt__tilde__, P.n1, P.H1 ],
               color = [ '1' ],
               lorentz = [ L.FFS2 ],
               couplings = {(0,0):C.GC_107})

V_197 = Vertex(name = 'V_197',
               particles = [ P.vt__tilde__, P.n1, P.H2 ],
               color = [ '1' ],
               lorentz = [ L.FFS2 ],
               couplings = {(0,0):C.GC_108})

V_198 = Vertex(name = 'V_198',
               particles = [ P.n1, P.vt, P.H1 ],
               color = [ '1' ],
               lorentz = [ L.FFS4 ],
               couplings = {(0,0):C.GC_107})

V_199 = Vertex(name = 'V_199',
               particles = [ P.n1, P.vt, P.H2 ],
               color = [ '1' ],
               lorentz = [ L.FFS4 ],
               couplings = {(0,0):C.GC_108})

V_200 = Vertex(name = 'V_200',
               particles = [ P.ve__tilde__, P.n2, P.H1 ],
               color = [ '1' ],
               lorentz = [ L.FFS2 ],
               couplings = {(0,0):C.GC_112})

V_201 = Vertex(name = 'V_201',
               particles = [ P.ve__tilde__, P.n2, P.H2 ],
               color = [ '1' ],
               lorentz = [ L.FFS2 ],
               couplings = {(0,0):C.GC_113})

V_202 = Vertex(name = 'V_202',
               particles = [ P.n2, P.ve, P.H1 ],
               color = [ '1' ],
               lorentz = [ L.FFS4 ],
               couplings = {(0,0):C.GC_112})

V_203 = Vertex(name = 'V_203',
               particles = [ P.n2, P.ve, P.H2 ],
               color = [ '1' ],
               lorentz = [ L.FFS4 ],
               couplings = {(0,0):C.GC_113})

V_204 = Vertex(name = 'V_204',
               particles = [ P.vm__tilde__, P.n2, P.H1 ],
               color = [ '1' ],
               lorentz = [ L.FFS2 ],
               couplings = {(0,0):C.GC_117})

V_205 = Vertex(name = 'V_205',
               particles = [ P.vm__tilde__, P.n2, P.H2 ],
               color = [ '1' ],
               lorentz = [ L.FFS2 ],
               couplings = {(0,0):C.GC_118})

V_206 = Vertex(name = 'V_206',
               particles = [ P.n2, P.vm, P.H1 ],
               color = [ '1' ],
               lorentz = [ L.FFS4 ],
               couplings = {(0,0):C.GC_117})

V_207 = Vertex(name = 'V_207',
               particles = [ P.n2, P.vm, P.H2 ],
               color = [ '1' ],
               lorentz = [ L.FFS4 ],
               couplings = {(0,0):C.GC_118})

V_208 = Vertex(name = 'V_208',
               particles = [ P.vt__tilde__, P.n2, P.H1 ],
               color = [ '1' ],
               lorentz = [ L.FFS2 ],
               couplings = {(0,0):C.GC_122})

V_209 = Vertex(name = 'V_209',
               particles = [ P.vt__tilde__, P.n2, P.H2 ],
               color = [ '1' ],
               lorentz = [ L.FFS2 ],
               couplings = {(0,0):C.GC_123})

V_210 = Vertex(name = 'V_210',
               particles = [ P.n2, P.vt, P.H1 ],
               color = [ '1' ],
               lorentz = [ L.FFS4 ],
               couplings = {(0,0):C.GC_122})

V_211 = Vertex(name = 'V_211',
               particles = [ P.n2, P.vt, P.H2 ],
               color = [ '1' ],
               lorentz = [ L.FFS4 ],
               couplings = {(0,0):C.GC_123})

V_212 = Vertex(name = 'V_212',
               particles = [ P.ve__tilde__, P.n3, P.H1 ],
               color = [ '1' ],
               lorentz = [ L.FFS2 ],
               couplings = {(0,0):C.GC_127})

V_213 = Vertex(name = 'V_213',
               particles = [ P.ve__tilde__, P.n3, P.H2 ],
               color = [ '1' ],
               lorentz = [ L.FFS2 ],
               couplings = {(0,0):C.GC_128})

V_214 = Vertex(name = 'V_214',
               particles = [ P.n3, P.ve, P.H1 ],
               color = [ '1' ],
               lorentz = [ L.FFS4 ],
               couplings = {(0,0):C.GC_127})

V_215 = Vertex(name = 'V_215',
               particles = [ P.n3, P.ve, P.H2 ],
               color = [ '1' ],
               lorentz = [ L.FFS4 ],
               couplings = {(0,0):C.GC_128})

V_216 = Vertex(name = 'V_216',
               particles = [ P.vm__tilde__, P.n3, P.H1 ],
               color = [ '1' ],
               lorentz = [ L.FFS2 ],
               couplings = {(0,0):C.GC_132})

V_217 = Vertex(name = 'V_217',
               particles = [ P.vm__tilde__, P.n3, P.H2 ],
               color = [ '1' ],
               lorentz = [ L.FFS2 ],
               couplings = {(0,0):C.GC_133})

V_218 = Vertex(name = 'V_218',
               particles = [ P.n3, P.vm, P.H1 ],
               color = [ '1' ],
               lorentz = [ L.FFS4 ],
               couplings = {(0,0):C.GC_132})

V_219 = Vertex(name = 'V_219',
               particles = [ P.n3, P.vm, P.H2 ],
               color = [ '1' ],
               lorentz = [ L.FFS4 ],
               couplings = {(0,0):C.GC_133})

V_220 = Vertex(name = 'V_220',
               particles = [ P.vt__tilde__, P.n3, P.H1 ],
               color = [ '1' ],
               lorentz = [ L.FFS2 ],
               couplings = {(0,0):C.GC_137})

V_221 = Vertex(name = 'V_221',
               particles = [ P.vt__tilde__, P.n3, P.H2 ],
               color = [ '1' ],
               lorentz = [ L.FFS2 ],
               couplings = {(0,0):C.GC_138})

V_222 = Vertex(name = 'V_222',
               particles = [ P.n3, P.vt, P.H1 ],
               color = [ '1' ],
               lorentz = [ L.FFS4 ],
               couplings = {(0,0):C.GC_137})

V_223 = Vertex(name = 'V_223',
               particles = [ P.n3, P.vt, P.H2 ],
               color = [ '1' ],
               lorentz = [ L.FFS4 ],
               couplings = {(0,0):C.GC_138})
...
V_243 = Vertex(name = 'V_243',
               particles = [ P.ve__tilde__, P.n1, P.Zp ],
               color = [ '1' ],
               lorentz = [ L.FFV3 ],
...
V_247 = Vertex(name = 'V_247',
               particles = [ P.vm__tilde__, P.n1, P.Zp ],
               color = [ '1' ],
               lorentz = [ L.FFV3 ],
...
V_251 = Vertex(name = 'V_251',
               particles = [ P.vt__tilde__, P.n1, P.Zp ],
               color = [ '1' ],
               lorentz = [ L.FFV3 ],
...
V_255 = Vertex(name = 'V_255',
               particles = [ P.ve__tilde__, P.n2, P.Zp ],
               color = [ '1' ],
               lorentz = [ L.FFV3 ],
...
V_259 = Vertex(name = 'V_259',
               particles = [ P.vm__tilde__, P.n2, P.Zp ],
               color = [ '1' ],
               lorentz = [ L.FFV3 ],
...
V_263 = Vertex(name = 'V_263',
               particles = [ P.vt__tilde__, P.n2, P.Zp ],
               color = [ '1' ],
               lorentz = [ L.FFV3 ],
...
V_267 = Vertex(name = 'V_267',
               particles = [ P.ve__tilde__, P.n3, P.Zp ],
               color = [ '1' ],
               lorentz = [ L.FFV3 ],
...
V_271 = Vertex(name = 'V_271',
               particles = [ P.vm__tilde__, P.n3, P.Zp ],
               color = [ '1' ],
               lorentz = [ L.FFV3 ],
...
V_275 = Vertex(name = 'V_275',
               particles = [ P.vt__tilde__, P.n3, P.Zp ],
               color = [ '1' ],
               lorentz = [ L.FFV3 ],
